...
**Entire Type data distribution** ![type distribution](https://github.com/yayuchen/melbourne_housing/blob/main/images/type%20distribution.png?raw=True)

**Difference of Type percentage** ![difference type](https://github.com/yayuchen/melbourne_housing/blob/main/images/subset%20type%20distribution.png?raw=True)

**Numerical data analysis** ![numerical data](https://github.com/yayuchen/melbourne_housing/blob/main/images/numerical%20data.png?raw=True)
